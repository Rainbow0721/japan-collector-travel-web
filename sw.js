const CACHE_NAME='tabi-mate-v17';
const APP_ASSETS=['./','./index.html','./styles.css','./data.js','./places.final.js','./transport-data.js','./goshuin-guide.js','./app.js','./manifest.webmanifest','./vendor/leaflet/leaflet.css','./vendor/leaflet/leaflet.js','./vendor/leaflet/marker-icon.png','./vendor/leaflet/marker-icon-2x.png','./vendor/leaflet/marker-shadow.png'];
