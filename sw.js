const CACHE_NAME='tabi-mate-v22';
const APP_ASSETS=['./','./index.html','./styles.css','./config.js','./data.js','./places.final.js','./transport-data.js','./goshuin-guide.js','./itinerary-core.js','./app.js','./companion.js','./manifest.webmanifest','./vendor/leaflet/leaflet.css','./vendor/leaflet/leaflet.js','./vendor/leaflet/marker-icon.png','./vendor/leaflet/marker-icon-2x.png','./vendor/leaflet/marker-shadow.png'];
