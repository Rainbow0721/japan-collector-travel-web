...
const TRAVEL_COLLECTIONS=[{id:'asakusa-shichifukujin',name:'淺草名所七福神',aliases:['淺草七福神','浅草七福神','淺草名所七福神','浅草名所七福神','淺草七福神御朱印','七福神御朱印'],sourceUrl:'https://www.asakusa7.jp/',checkedAt:'2026-08-02',scope:'COMPLETE_COLLECTION',expectedStopCount:9,notes:['名稱雖為七福神，官方巡禮實際包含九處寺社。','全年可巡禮；授與時間與臨時變更應在出發前查各寺社公告。'],places:[
  {id:'asakusa-shrine',name:'淺草神社',nameJa:'浅草神社',deity:'惠比壽',collectionVisitMinutes:25,lat:35.71519,lng:139.79745,officialUrl:'https://www.asakusajinja.jp/'},
  {id:'sensoji',name:'淺草寺',nameJa:'浅草寺',deity:'大黑天',collectionVisitMinutes:45,lat:35.71477,lng:139.79666,officialUrl:'https://www.senso-ji.jp/'},
...
function collectionPlaceRecord(place,collection){return{id:place.id,name:place.name,nameJa:place.nameJa,nameEn:'',aliases:[],area:'淺草名所七福神',zone:'asakusa',category:'神社寺廟',emoji:'⛩',duration:place.collectionVisitMinutes||25,collectionVisitMinutes:place.collectionVisitMinutes||25,admission:0,cost:0,popularity:86,tags:['御朱印','七福神',collection.name,place.deity,'完整巡禮必訪'],desc:`${collection.name}的${place.deity}札所。完整巡禮九處缺一不可。`,lat:place.lat,lng:place.lng,officialUrl:place.officialUrl,sourceUrl:place.officialUrl,sourceCheckedAt:collection.checkedAt,completionScore:100,dataTier:'P0 收藏知識',curated:true,recommendationEligible:true,requiresLiveCheck:true,collectionId:collection.id,collectionRole:place.deity}}
