...
- 繁體中文桌面與手機版面
- 107 筆人工精選核心地點（含 27 筆具官方來源與價位分類的特色餐廳），加上 1,000 筆 OpenStreetMap／Wikidata 永久候選資料
...
- 選擇 3–7 天、每日預算與旅行步調
- 長者、兒童與嬰兒車同行設定
- 依東京區域模板與 107 筆人工精選產生每日行程；可辨識壽司、燒鳥、壽喜燒、螃蟹、豬排、拉麵、沾麵、天婦羅、鰻魚、燒肉等具體料理需求
...
- 目前永久候選層嚴格稽核為半成品 267、無行程參考性 733；另有 107 筆人工精選推薦。隔離列不會被宣稱為景點或進入排行程。
