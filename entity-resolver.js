(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.EntityResolver=api})(typeof globalThis!=='undefined'?globalThis:this,function(){
  ...
  function create(entries=[]){
    ...
    function result(entry,confidence,source){return{status:entry.resolution||'RESOLVED',confidence,entityId:entry.entityId||null,entityType:entry.entityType,canonicalLabel:entry.canonicalLabel||null,candidates:[...(entry.candidateEntityIds||[])],candidateLabels:[...(entry.candidateLabels||[])],source}}
